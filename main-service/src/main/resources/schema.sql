...
CREATE TABLE IF NOT EXISTS requests (
    ...
    CONSTRAINT fk_user_req FOREIGN KEY (requester_id) REFERENCES users (user_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS likes (
    ...
    CONSTRAINT fk_like_on_owner FOREIGN KEY (user_id) REFERENCES users (user_id),
    CONSTRAINT fk_like_on_comment FOREIGN KEY (comment_id) REFERENCES comments (id)
    );